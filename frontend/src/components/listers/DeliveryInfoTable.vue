        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DeliveryInfo :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "shopTelNo", value: "shopTelNo" },
                    { text: "deliveryAddress", value: "deliveryAddress" },
                    { text: "deliveryTelNo", value: "deliveryTelNo" },
                    { text: "isRapidDelivery", value: "isRapidDelivery" },
        ...
        async created() {
            ...
            this.values = temp.data._embedded.deliveryinfos;
