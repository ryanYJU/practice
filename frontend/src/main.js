...
pluralCaseList.push( {plural: "menuInfos", pascal: "MenuInfo"} )
pluralCaseList.push( {plural: "orderStatuses", pascal: "OrderStatus"} )
pluralCaseList.push( {plural: "결제이력", pascal: "결제이력"} )
pluralCaseList.push( {plural: "paymentInfos", pascal: "PaymentInfo"} )
...
pluralCaseList.push( {plural: "orderDetails", pascal: "OrderDetail"} )

pluralCaseList.push( {plural: "deliveryInfos", pascal: "DeliveryInfo"} )
